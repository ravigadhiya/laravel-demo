                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="title" name="name" placeholder="Enter Title" type="text" value="{{$post->name}}">
                                <input class="form-control" id="title" name="slug" placeholder="Enter Title" type="text" value="{{$post->slug}}">
                            </div>
